...
def filter_data(data_var_name, sample_size=30000, random_state=42):
    ...
    if data_var_name in globals():
        ...
        raise ValueError(f"Global variable '{data_var_name}' not found.")

    return data_by_year_training_sample